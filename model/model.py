...
class ATT_model(nn.Module):
    def __init__(self, vocab_size, embed_dim, hidden_dim, dropout_rate, PAD, bidirectional=True):
    ...
    def forward(self, documents, doc_lens, querys, query_lens):
        ...
        beta_aver = beta_sum / doc_lens.unsqueeze(1).unsqueeze(2).expand_as(beta_sum)
